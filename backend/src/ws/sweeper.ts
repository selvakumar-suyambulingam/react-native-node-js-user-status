...
import { PresenceWebSocketServer } from './server';
...
export class PresenceSweeper {
  private wsServer: PresenceWebSocketServer;
  private lastKnownStatus: Map<string, boolean> = new Map();
  private intervalId?: NodeJS.Timeout;

  constructor(wsServer: PresenceWebSocketServer) {
   ...
   */
  private async checkPresenceChanges() {
    try {
